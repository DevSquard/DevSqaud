package com.devsquad.oauth.controller;
...
import com.devsquad.oauth.service.OAuthService;
...
public class OAuthController {
	...
	@GetMapping("/{provider}")
	public ResponseEntity<LoginResponse> googleSignIn(@RequestParam("code") final String code, HttpServletResponse res, @PathVariable("provider") final String provider) {
		log.info(code);
