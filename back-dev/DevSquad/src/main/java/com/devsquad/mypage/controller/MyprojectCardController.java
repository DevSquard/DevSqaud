...
public class MyprojectCardController {
	...
	// 카드삭제
	@Operation(summary = "카드 삭제하기", description = "프로젝트 카드를 삭제합니다")
	@DeleteMapping("/{id}")
	...
	// 카드수정
	@Operation(summary = "카드 수정하기", description = "프로젝트 카드를 수정합니다")
	@PatchMapping("")
	...
	// 카드 리스트
	@Operation(summary = "카드 리스트조회", description = "프로젝트 카드를 조회합니다")
	@GetMapping("")
